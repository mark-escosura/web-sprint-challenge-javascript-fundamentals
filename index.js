...
// nestedFunction was created inside myFunction so the nestedFunction will only be available inside of it's parent function "myFunction" and also as we know 
...
// console.log(animalNames(zooAnimals));
  ...
  */
  ...
  function lowerCaseNames(array){
    ...
    let lowerCaseAnimals = array.map((animal) => {
  ...
  */
  ...
  function lowPopulationAnimals(array){
    ...
    let newArr = array.filter(item => item.population < 5);
    return newArr;
  ...
  */
  ...
  function USApop(array){
    ...
    const totalPopulation = array.reduce((acc, value) => {return acc + value.population}, 0);
...
/* 🐴🐴🐴 Step 3: Surface Area Method 🐴🐴🐴
  ...
  CuboidMaker.prototype.surfaceArea= function(){
    ...
    const cubeArea= (this.length * this.width + this.length * this.height + this.width * this.height)*2;
    return cubeArea;
